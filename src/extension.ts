...
export function activate(context: vscode.ExtensionContext) {
    ...
    let quickPickDisposable = vscode.commands.registerCommand('php-snippets.showSnippets', async () => {
        try {
            ...
            const selected = await vscode.window.showQuickPick(items, {
                ...
                matchOnDetail: true,
                placeHolder: 'Search PHP snippets...'
            });
    ...
    let webviewDisposable = vscode.commands.registerCommand('php-snippets.showSnippetsWebview', () => {
